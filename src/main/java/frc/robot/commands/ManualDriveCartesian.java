...
public class ManualDriveCartesian extends CommandBase {
  /**
   * Creates a new ManualDriveCartesian.
   */

  private ArcadeDriveSubsystem robotDriveSubsystem;

    public ManualDriveCartesian(ArcadeDriveSubsystem subsystem) {
